...
Viewer3D::Screen::Screen(QWidget *parent)
	: QGLViewer(parent),
	gizmoType(TRANSLATE),
	fbo(0),
	phong(0),
...
void Viewer3D::Screen::AddModel(Model3D * model_)
{
	makeCurrent();
	model_->Init();
...
void Viewer3D::Screen::SetGizmoType(GizmoType gizmoType_)
{
...
void Viewer3D::Screen::resizeGL(int width, int height)
{
...
void Viewer3D::Screen::mousePressEvent(QMouseEvent *e_)
{
...
void Viewer3D::Screen::mouseMoveEvent(QMouseEvent *e_)
{
	QPoint cursor(e_->pos());
...
void Viewer3D::Screen::mouseReleaseEvent(QMouseEvent *e_)
{
...
void Viewer3D::Screen::wheelEvent(QWheelEvent * e_)
{
...
void Viewer3D::Screen::ToggleSelection(int idx_)
{
	if (std::find(selecteds.begin(), selecteds.end(),
...
void Viewer3D::GizmoChanged()
{
	if (ui->radioButton->isChecked()) {
		...
		ui->openGLWidget->SetGizmoType(Screen::SCALE);
		ui->radioButton->setChecked(false);
		ui->radioButton_2->setChecked(false);
	}
